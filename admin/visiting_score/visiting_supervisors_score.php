...
$mysql_query = "SELECT * FROM industrial_registration";
...
if(isset($_POST["btn_search"])){
  ...
  if($search_by!=""&& $search_term!=""){
    ...
    switch ($search_by) {
      ...
      $mysql_query = "SELECT * FROM industrial_registration WHERE first_name LIKE '%$search_term%'";

      break;

      case 'Last Name':

      $mysql_query = "SELECT * FROM industrial_registration WHERE last_name LIKE '%$search_term%'";

      break;

      case 'Reg Number':

      $mysql_query = "SELECT * FROM industrial_registration WHERE reg_number LIKE '%$search_term%'";
      ...
      $mysql_query = "SELECT * FROM industrial_registration WHERE visiting_supervisor_grade LIKE '%$search_term%'";
            ...
            <div class = "panel-body pbody">
              ...
              <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
                    $mysql_query_command = $mysql_query;
                    $execute_result_query = mysqli_query($conn,$mysql_query_command);
