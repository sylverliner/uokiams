...
if(isset($_POST["btn_search"])){
  ...
  if($search_by!=""&& $search_term!=""){
    ...
    switch ($search_by) {
      ...
      $mysql_query_1 = "SELECT * FROM students_assumption WHERE reg_number LIKE '%$search_term%'";
            ...
            <div class="col-xs-6 col-xs-offset-6">
              <div class="input-group">
                ...
                <div style="float: right; margin-left: 5px;">
                    <a href="../SimpleXLSXGen/export.php" class="btn btn-primary">Export to Excel</a>
                </div>
              </div>
            </div>
          </div>
