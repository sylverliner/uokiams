...
if(isset($_POST["btn_submit"])){
	...
	if($execute_mysql_query1 = mysqli_query($conn,$mysql_query1)){
		...
		if($check_existence==1){
			$mysql_query3 = "UPDATE `industrial_registration` SET `visiting_supervisor_grade` = '$grade_score' WHERE reg_number = '$student_reg_number'";
			$execute_mysql_query3 = mysqli_query($conn,$mysql_query3);
		}else{

		$mysql_query4 = "SELECT * FROM vira_registration WHERE reg_number='$student_reg_number'";
		...
		if($check_existence2==1){
			$mysql_query5 = "UPDATE `vira_registration` SET `visiting_supervisor_grade` = '$grade_score' WHERE reg_number = '$student_reg_number'";
