...
$check_content_existence = "SELECT * FROM week11_table WHERE reg_number='$student_reg_number'";
  ...
  <div class="container-fluid">
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        ...
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_week10.php">&larr; Previous</a></li>
             <li class = "next"><a href = "elogbook_week12.php">Next &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Week 11</span>
        </div>
        <hr>
        ...
        <tbody>
          <?php
                  ...
                  $get_previous_data = "SELECT * FROM week10_table WHERE reg_number='$student_reg_number'";
                  $execute_get_query = mysqli_query($conn,$get_previous_data);
                  $get_data = mysqli_fetch_assoc($execute_get_query);

                  $monday_job_assigned_holder = $get_data["monday_job_assigned"] ?? null;
				  $monday_skill_acquired_holder = $get_data["monday_special_skill_acquired"] ?? null;
			
			      $tuesday_job_assigned_holder = $get_data["tuesday_job_assigned"] ?? null;
				  $tuesday_skill_acquired_holder = $get_data["tuesday_special_skill_acquired"] ?? null;
			
			      $wednesday_job_assigned_holder = $get_data["wednesday_job_assigned"] ?? null;
				  $wednesday_skill_acquired_holder = $get_data["wednesday_special_skill_acquired"] ?? null;
			
			      $thursday_job_assigned_holder = $get_data["thursday_job_assigned"] ?? null;
				  $thursday_skill_acquired_holder = $get_data["thursday_special_skill_acquired"] ?? null;
			
			      $friday_job_assigned_holder = $get_data["friday_job_assigned"] ?? null;
				  $friday_skill_acquired_holder = $get_data["friday_special_skill_acquired"] ?? null;
