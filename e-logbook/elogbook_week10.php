...
$check_content_existence = "SELECT * FROM week10_table WHERE reg_number='$student_reg_number'";
    ...
    <div class = "panel">
      ...
      <div id="navigation_holder">
          <ul class = "pager">
             ...
             <li class = "next"><a href = "elogbook_week11.php">Next &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
