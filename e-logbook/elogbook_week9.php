...
$check_content_existence = "SELECT * FROM week9_table WHERE reg_number='$student_reg_number'";
      ...
      <div class="panel-body pbody">
        ...
        <tbody>
          <?php
                  ...
                  $get_previous_data = "SELECT * FROM week9_table WHERE reg_number='$student_reg_number'";
