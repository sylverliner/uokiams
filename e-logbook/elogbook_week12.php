...
$check_content_existence = "SELECT * FROM week12_table WHERE reg_number='$student_reg_number'";
    ...
    <div class = "panel">
      ...
      <div class="panel-body pbody">
        <div id="navigation_holder">
          <ul class = "pager">
             <li class = "previous"><a href = "elogbook_week11.php">&larr; Previous</a></li>
             <li class = "next disabled"><a href = "#">Next &rarr;</a></li>
        </ul>
        </div>
        <div id="week_holder">
          <span style="font-size:1.3em;font-weight:bold;">Week 12</span>
        </div>
        <hr>
