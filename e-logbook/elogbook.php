...
$check_content_existence = "SELECT * FROM week1_table WHERE reg_number='$student_reg_number'";
      ...
      <div class="panel-body pbody">
        ...
        <tbody>
          <?php
                  ...
                  $get_previous_data = "SELECT * FROM week1_table WHERE reg_number='$student_reg_number'";
