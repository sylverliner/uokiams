...
$check_content_existence = "SELECT * FROM week2_table WHERE reg_number='$student_reg_number' LIMIT 1";
      ...
      <div class="panel-body pbody">
        ...
        <tbody>
          <?php
                  ...
                  $get_previous_data = "SELECT * FROM week2_table WHERE reg_number='$student_reg_number'";
